...
export function DailyQuests() {
  const { activeQuests } = useLifeOSStore()
              ...
              <div className="flex items-start gap-3 mb-2">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-1">
                    <h3 className={`text-sm font-semibold ${isCompleted ? 'text-green-400 line-through' : 'text-white'
                      }`}>
                      Quest #{quest.questId}
                    </h3>
                  ...
                  <div className="progress-bar h-2">
                    <div
                      className={`progress-fill ${isCompleted
                          ? 'bg-green-500'
